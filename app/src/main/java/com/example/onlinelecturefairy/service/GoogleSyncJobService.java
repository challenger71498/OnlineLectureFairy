...
////            new GoogleSyncJobService.deleteCal(this, mCredential).execute();
////        }
////        return;
////    }
////
...
////                // Google Calendar API 호출
////                new GoogleSyncJobService.MakeRequestTask(this, mCredential).execute();
////            }
////        } catch (Exception e) {
////            e.printStackTrace();
////        }
...
////        protected void onPreExecute() {
////            super.onPreExecute();
////            progressDialog = new ProgressDialog(GoogleSyncJobService.this);
////            progressDialog.show();
////        }
////
////        @Override
...
////        private GoogleSyncJobService mActivity;
////        List<String> eventStrings = new ArrayList<String>();
////        List<Event> ourEventArray = new ArrayList<Event>();
////
////        public deleteCal(GoogleSyncJobService activity, GoogleAccountCredential credential) {
////
////            mActivity = activity;
////
...
////        List<Event> ourEventArray = new ArrayList<Event>();
////
////        public MakeRequestTask(GoogleSyncJobService activity, GoogleAccountCredential credential) {
////
////            mActivity = activity;
////
////            HttpTransport transport = AndroidHttp.newCompatibleTransport();
...
////                            GoogleSyncJobService.REQUEST_AUTHORIZATION);
////                } else {
